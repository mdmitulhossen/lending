      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <Card className="shadow-xl border-0">
          <CardHeader className="space-y-2 text-center">
            ...
            <CardDescription className="text-gray-600">Sign in to your QuickieCashie account</CardDescription>
          </CardHeader>
          <CardContent>
            <LoginForm />
          </CardContent>
...
function LoginForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <Button
        type="submit"
        className="w-full h-12 bg-blue-600 hover:bg-cyan-500 transition-colors"
        disabled={isLoading}
      >
